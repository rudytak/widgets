...
class Coordinate_Canvas {
    ...
    draw() {
        ...
        if (this.quadrants == "full") {
            ...
            x_axis_pos = this.x_axis.start + this.x_axis.increment / 2;
            y_axis_pos = this.y_axis.start + this.y_axis.increment / 2;
        } else if (this.quadrants == 2) {
            x_axis_pos = this.x_axis.end - this.x_axis.increment / 2;
            y_axis_pos = this.y_axis.start + this.y_axis.increment / 2;
        } else if (this.quadrants == 3) {
            x_axis_pos = this.x_axis.end - this.x_axis.increment / 2;
            y_axis_pos = this.y_axis.end - this.y_axis.increment / 2;
        ...
        if (this.y_axis.show) {
            ...
            p.textAlign(p.BOTTOM, p.LEFT);
            p.textSize(20);
            p.text(this.y_axis.label, xa + 5, 18)
            p.pop();
        }
